...
#pragma warning restore 0414
        ...
        public bool UseWaveMask
        {
            ...
            set
            {
                PMat.SetFeature(ref useWaveMask, value);
            }
        }
        ...
        private void CleanUp()
        {
            ...
            foreach(Transform child in transform)
            {
                ...
                {
                    PUtilities.DestroyGameobject(child.gameObject);  
                }
            }
        }
        ...
        private void SetShaderParams()
        {
            ...
            Shader.SetGlobalTexture(PMat.NOISE_TEX, PPoseidonSettings.Instance.NoiseTexture);
        }
        ...
        private void RenderTiledMesh(Camera cam)
        {
            ...
            Profile.SetMaterialKeywords(mat);
            ...
            {
                PMat.SetTexture(PMat.REFLECTION_TEX, GetReflectionRt(cam));
            }
        ...
        private void RenderReflectionTextureSRP(ScriptableRenderContext context, Camera cam)
        {
            ...
            if (reflectionCamera.transform.rotation != Quaternion.identity)
            {
                ...
                UniversalRenderPipeline.SubmitRenderRequest(reflectionCamera, new RenderPipeline.StandardRequest());
#else
